...
**Dungeon Gear** is a special item that takes 1 slot. When you need it, it becomes any reasonable adventuring tool like a club or knife, arrows, a tent, rope, torches, rations, etc.

For some kinds of items roll d6 to determine how much is available.
...
If you think you might need something in particular, ask the Guide if they would allow it as Dungeon Gear. If they say no, ask if its otherwise available and what it takes to acquire it.
...
| Shortword             |    2 | Minimum 2                                      |
| Shortspear            |    2 | Strong +1                                      |
...
| Pike         |    9 |   2   | Strong Damage +2       |
|              |      |       | Critical Damage +d6\*  |
| Zweihander   |   10 |   2   | Minimum Damage 3       |
|              |      |       | Critical Damage +d6\*  |
| Halberd      |   10 |   2   | Minimum Damage 2       |
|              |      |       | Strong Damage +1       |
|              |      |       | Critical Damage +d6\*  |
